...
replacing SPECIFIC-ID by the ID of your container (you can check this by issuing the command \textttt{docker container ls} and searching for the Container ID of dev-peer0.org1...).
...
This request is semantically equivalent to the script \textttt{showIdentity}. In fact, the client just loads this script, and manages the credentials for you.  
